...
> `<Randall Ali>` (`<2025>`) _`<Tangible Audio Analysis, Processing, and Synthesis>`_. `<https://randyaliased.github.io/acspjbook/main/>`. Source files at `<https://github.com/randyaliased/acspjbook>`. CC BY 4.0.
